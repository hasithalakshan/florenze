...
class BillServiceProvider extends ServiceProvider
{
    ...
    protected function registerConfig()
    {
        ...
        $this->mergeConfigFrom(
            __DIR__.'/../Config/config.php', 'bill'
        );
    }
    ...
    {
        $viewPath = base_path('resources/views/modules/bill');
        ...
        $this->loadViewsFrom(array_merge(array_map(function ($path) {
            return $path . '/modules/bill';
        }, \Config::get('view.paths')), [$sourcePath]), 'bill');
    }
    ...
    {
        $langPath = base_path('resources/lang/modules/bill');
